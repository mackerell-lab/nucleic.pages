...
test('Summary angles follow the selected display mode without changing raw statistics', () => {
  ...
  try {
    ...
    const result = { parameter: { period: 360, unit: '°' }, displaySpec: { circularMode: 'signed_180' }, displayCut: -180, series: [{ statistics }] };
    ...
    result.displaySpec.circularMode = 'auto';
    summaryCards(root, result);

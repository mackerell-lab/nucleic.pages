...
async function stageFiles(stage) {
  ...
  const mapping = {
    ...
    assets:['assets.mjs','../core/survey-codec.js','../core/shared-survey-codec.js','../core/bundled-survey-codec.js','parameter_registry.mjs','survey_terms.mjs','../config/geometry_parameters_v1.json'],
    'validate-release':['assets.mjs','../core/survey-codec.js','../core/shared-survey-codec.js','../core/bundled-survey-codec.js'],
  };
